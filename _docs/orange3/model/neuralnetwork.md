...
![](/assets/images/model/NeuralNetwork-stamped.png.webp)
...
The first example is a classification task on *iris* dataset. We compare the results of **Neural Network** with the [Logistic Regression][逻辑回归].

![](/assets/images/model/NN-Example-Test.png.webp)

The second example is a prediction task, still using the *iris* data. This workflow shows how to use the *Learner* output. We input the **Neural Network** prediction model into [Predictions][预测] and observe the predicted values.

![](/assets/images/model/NN-Example-Predict.png.webp)
